...
#include <cvmmap/compat/detail/boost_compat/detail/returns.hpp>
#include <cvmmap/compat/detail/boost_compat/mem_fn.hpp>
#include <cvmmap/compat/detail/boost_compat/type_traits.hpp>
#include <utility>
